      ...
      child: Column(
        children: [
          ...
          DropdownButtonFormField<String>(
            ...
            items: NiveauEtude.niveaux.entries.map((e) => DropdownMenuItem(value: e.key, child: Text(e.value))).toList(),
            onChanged: (val) => setState(() => _selectedNiveau = val ?? _selectedNiveau),
          ),
          const SizedBox(height: 16),
          DropdownButtonFormField<int>(
            value: _selectedAnnee,
            decoration: _dropdownDecoration('Année d\'entrée', Icons.calendar_today_outlined),
            items: List.generate(5, (i) {
              final y = DateTime.now().year - i;
              return DropdownMenuItem(value: y, child: Text(y.toString()));
            }),
            onChanged: (val) => setState(() => _selectedAnnee = val ?? _selectedAnnee),
          ),
          const SizedBox(height: 16),
          CheckboxListTile(
